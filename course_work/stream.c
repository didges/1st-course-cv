...
void read_text(text *my_text)
{
    ...
    while(current_symb != '\n')
    {
        ...
        if(logic)
        {
            ...
            my_text->arr_of_sent[my_text->count_of_sent]->size_of_snt = 20; 
            ...
            my_text->arr_of_sent[my_text->count_of_sent]->size_of_word = 50;
    ...
    for(int i = 0; i <= my_text->arr_of_sent[my_text->count_of_sent]->count_of_words; i++)
    {
        free(my_text->arr_of_sent[my_text->count_of_sent]->arr_of_words[i]);
    }
